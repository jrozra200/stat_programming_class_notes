...
update_light <- function(light, len_of_green_sec){
...
summary_stats_45 <- data.frame()

for(iteration in 1:10){
        
        print(paste("cars per minute: ", iteration, sep = ""))
        
        for(log in c(15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195,
                     210, 225, 240, 255, 270, 285, 300)){
                
                print(paste("seconds per green: ", log, sep = ""))
                ...
                tmp <- data.frame(cars_per_minute = cars_per_second,
                                  replicate = iteration,
                                  length_of_green = log,
                ...
                summary_stats_45 <- rbind(summary_stats_45, tmp)
        }
}

write.csv(summary_stats_45, "~/Desktop/MAT 7500 - Statistical Programming/traffic light sim/summary_stats.csv", row.names = FALSE)
