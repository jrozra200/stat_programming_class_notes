...
for(cps in c(1, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60)){
...
write.csv(summary_stats, "~/Desktop/MAT 7500 - Statistical Programming/traffic light sim/summary_stats.csv", row.names = FALSE)
